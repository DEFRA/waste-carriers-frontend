Feature: Session termination
  ...
  Even after the registration has been saved in the database, the user should not be able to (accidentally or otherwise) edit the registration by accessing the registration flow pages which edit the registration.
