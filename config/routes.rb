Registrations::Application.routes.draw do
  #scope '(:locale)' do
    ...
    get "your-registration/directors" => "directors#newDirectorDetails", :via => [:get], :as => :newDirectorDetails
    post "your-registration/directors" => "directors#updateNewDirectorDetails"
