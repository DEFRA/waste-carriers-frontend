...
module RegistrationExportHelper
  ...
  def get_headers_full()
    [
      ...
      I18n.t('reports.fields.address_line_1'),
      I18n.t('reports.fields.address_line_2'),
      I18n.t('reports.fields.address_line_3'),
      I18n.t('reports.fields.address_line_4'),
  ...
  def get_registration_data_full(registration)
    ...
    [
      ...
      registered_addr.house_number,
      registered_addr.address_line_1,
      registered_addr.address_line_2,
      registered_addr.address_line_3,
      registered_addr.address_line_4,
      registered_addr.town_city,
