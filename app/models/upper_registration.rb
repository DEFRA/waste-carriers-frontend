...
class UpperRegistration
  ...
  attr_accessor :business_name, :postcode, :full_name, :job_title, :telephone_number, :email_address, :business_type
  attr_accessor :company_house_number, :alt_full_name, :alt_job_title, :alt_telephone_number, :alt_email_address
  attr_accessor :relevant_conviction, :copy_cards, :payment_method
